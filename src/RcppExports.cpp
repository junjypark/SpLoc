...
RcppExport SEXP _SpLoc_SpLocDiffC2(SEXP NNmatrixSEXP, SEXP ymatSEXP, SEXP groupSEXP, SEXP npermSEXP, SEXP alphaSEXP, SEXP sSEXP, SEXP pUSEXP, SEXP pYSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::sp_mat& >::type NNmatrix(NNmatrixSEXP);
    ...
    Rcpp::traits::input_parameter< SEXP >::type pU(pUSEXP);
    Rcpp::traits::input_parameter< SEXP >::type pY(pYSEXP);
    rcpp_result_gen = Rcpp::wrap(SpLocDiffC2(NNmatrix, ymat, group, nperm, alpha, s, pU, pY));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_SpLoc_SpLocDiffC2", (DL_FUNC) &_SpLoc_SpLocDiffC2, 8},
    {NULL, NULL, 0}
};
