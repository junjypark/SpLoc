...
RcppExport SEXP _SpLoc_SpLocMeanC2(SEXP NNmatrixSEXP, SEXP ymatSEXP, SEXP npermSEXP, SEXP alphaSEXP, SEXP sSEXP, SEXP pUSEXP, SEXP pYSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::sp_mat& >::type NNmatrix(NNmatrixSEXP);
    ...
    Rcpp::traits::input_parameter< SEXP >::type pU(pUSEXP);
    Rcpp::traits::input_parameter< SEXP >::type pY(pYSEXP);
    rcpp_result_gen = Rcpp::wrap(SpLocMeanC2(NNmatrix, ymat, nperm, alpha, s, pU, pY));
    return rcpp_result_gen;
END_RCPP
}
// SpLocDiffC
